...
setLoading(true)
            ...
            try {
              ...
              // localStorage.setItem("africaImages", JSON.stringify(data.results)); // Cache images
            } catch (error) {
...
{/* result if search keyword does not exist */}
{loading==false&&images.length==0? <div className="flex items-center justify-center text-black font-bold">oops no result for &quot;{ query}&quot; </div>:""}
